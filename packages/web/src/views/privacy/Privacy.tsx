  ...
  return (
    <div>
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for Caravan is
      ...
      <p>
        ...
        in our Terms and Conditions, accessible from https://caravanapp.ca
      </p>
      ...
      <ul>
        <li>
          By emailing{' '}
          <a href="mailto:matt@caravanapp.ca" target="_top">
            matt@caravanapp.ca
          </a>
        </li>
      </ul>
