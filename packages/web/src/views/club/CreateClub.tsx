...
export default function CreateClub() {
  ...
  const leftComponent =
    <IconButton edge="start" className={classes.backButton} color="inherit" aria-label="Back" component={AdapterLink} to="/">
      <BackIcon />
    </IconButton>;
  ...
  function handleGroupNameChange(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) {
    setSelectedGroupNameValue(e.target.value);
  }

  const [selectedGroupBioValue, setSelectedGroupBioValue] = React.useState('');

  function handleGroupBioChange(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) {
    ...
    <React.Fragment>
      ...
      <main>
        <Container className={classes.formContainer} maxWidth="md">
          ...
          <Typography style={{fontWeight: 'bold', marginBottom: 10}}  variant="h5" component="h2">
            Group name
          </Typography>
          <TextField
          ...
          <Typography style={{fontWeight: 'bold', marginBottom: 20}} variant="h5" component="h2">
              ...
              <Grid key={0} item>
                <div>
                  <Paper className={classes.paper}>
                    <IconButton edge="start" className={classes.addButton} color="inherit" aria-label="Add" component={AdapterLink} to="/findbooks">
                      <AddIcon />
                    </IconButton>
                  </Paper>
                </div>
          ...
          <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between', width: '80%', marginBottom: 30}}>
          ...
          <Typography style={{fontWeight: 'bold', marginBottom: 30}} variant="h5" component="h2">
          ...
          <div className={classes.createButtonSection}>
            <Button variant="contained" disabled={selectedGroupBioValue === '' || selectedGroupNameValue === ''} className={classes.createButton}  size="small">
              Create
            </Button>
          </div>
